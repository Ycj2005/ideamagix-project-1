    ...
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <p className="font-semibold text-gray-800 text-lg">Dr. {profile?.name}</p>
        ...
        {!editing ? (
          <div className="flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs text-gray-400 uppercase font-medium">Speciality</p>
                <p className="text-gray-700">{profile?.speciality || "Not set"}</p>
              </div>
              <div>
                <p className="text-xs text-gray-400 uppercase font-medium">Experience</p>
                <p className="text-gray-700">{profile?.yoe || "N/A"} years</p>
              </div>
              <div>
